                        ...
                        {_this.state.booking_list.length ? (function () {
                                return _this.state.booking_list.map(booking => {
                                    let progresslist = [
                                        ...
                                        {
                                            label: 'Invoice',
                                            done: booking.invoice_list.length > 0
                                        }
                                    ];
                                                    ...
                                                    return <div className="btn-group">
                                                        ...
                                                        <div>
                                                            {
                                                                booking.hawb_generated ?
                                                                    <a className="btn btn-sm btn-outline-success small" target="_blank"
                                                                       href={booking.hawb_dummy_view_url}>
                                                                        <i className="fa fa-external-link-alt small"></i> Dummy Airway bill
                                                                    </a>
                                                                    :
                                                        ...
                                                        <div>
                                                            {
                                                                booking.hawb_generated ? <a className="btn btn-sm btn-outline-success small" target="_blank"
                                                                                            href={booking.hawb_view_url}>
                                                                        <i className="fa fa-external-link-alt small"></i> HAWB
                                                                    </a>
                                                                    : <button className="btn btn-sm btn-outline-secondary small" onClick={() => {
                                                                        window.modal_alert({content_html: '<p class="text-danger">HAWB not generated</p>'});
                                                                    }}>HAWB</button>
                                                        ...
                                                        <div>
                                                            {booking.mawb_generated ?
                                                                <a className="btn btn-sm btn-outline-success small"
                                                                   href={booking.mawb_view_url} target="_blank">
                                                                    <i className="fa fa-external-link-alt small"></i> MAWB
                                                                </a>
                                                                : <button className="btn btn-sm btn-outline-secondary small" onClick={() => {
                                                        ...
                                                        {booking.invoice_list.length ? <button className="btn btn-sm btn-outline-success small" onClick={() => {
                                                            _this.invoice_selection(booking.invoice_list);
                                                        }}>invoice list</button> : <button className="btn btn-sm btn-outline-secondary small" onClick={() => {
                                                            window.modal_alert({content_html: '<p class="text-danger">No invoice created</p>'});
                                                        }}>invoice</button>}
                                                    </div>;
                                                }
                                            }())}
